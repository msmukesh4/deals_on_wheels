package com.dealsonwheels.app.utils;
...
public class FancyDialog extends DialogFragment {
    public static final String TAG = FancyDialog.class.getSimpleName();
    private Builder builder;
    private static FancyDialog instance = new FancyDialog();

    public static FancyDialog getInstance() {
        return instance;
    }
    ...
    private boolean isHtmlFormatedData = false;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.dialog_fancy, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        if (builder != null) {
            ...
            if (builder.getBody() != null) {
                if (isHtmlFormatedData)
                    body.setText(Html.fromHtml(builder.getBody()));
                else
    ...
    public boolean isHtmlFormatedData() {
        return isHtmlFormatedData;
    }

    public void setHtmlFormatedData(boolean isHtmlFormatedData){
        this.isHtmlFormatedData = isHtmlFormatedData;
    }
    ...
    public static class Builder implements Serializable {
        ...
        public Dialog show() {
            return FancyDialog.getInstance().show(((Activity) context), this);
        }
